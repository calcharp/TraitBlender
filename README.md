...
TraitBlender is a Blender add-on for generating museum-style images and 3D meshes of specimens from theoretical morphospaces. **v2.0.1** targets **Blender 5.1+** (Python 3.13 wheels) on Windows, macOS, and Linux.
