...
class CameraConfig(TraitBlenderConfig):
    ...
    rotation: bpy.props.FloatVectorProperty(
        ...
        default=(0.0, 0.0, 0.0),
        subtype='EULER',
        get=get_property("bpy.data.objects['Camera'].rotation_euler", object_dependencies={"objects": ["Camera"]}),
        set=set_property("bpy.data.objects['Camera'].rotation_euler", object_dependencies={"objects": ["Camera"]}),
    )
